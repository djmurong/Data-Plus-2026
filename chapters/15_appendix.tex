...
\subsection{Descriptive Statistics (Q1)}
...
\subsection{Forecast Error vs. Lead Time (Q2)}
...
\subsection{Autocorrelation Structure of Forecast Errors (Q4, Q5)}
...
\subsection{Stratified Cross-Variable Error Matrices (Q7)}
...
\subsection{Spatial Correlation Across PJM Zones (Q8)}
...
\subsection{Spatial Correlation Variation by Stratum (Q9)}
...
\subsection{Threshold-Sensitivity Sweep (Q11)}
